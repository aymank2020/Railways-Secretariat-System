  ...
  Future<String> exportWarid({
    ...
    final rows = records
        .map((warid) => <String>[
              ...
              _formatNullableDate(warid.chairmanIncomingDate),
              warid.chairmanReturnNumber ?? '',
              _formatNullableDate(warid.chairmanReturnDate),
    ...
    final jsonRows = records.map((warid) {
      return <String, dynamic>{
        ...
        'chairman_incoming_number': warid.chairmanIncomingNumber,
        'chairman_incoming_date': warid.chairmanIncomingDate?.toIso8601String(),
        'chairman_return_number': warid.chairmanReturnNumber,
        'chairman_return_date': warid.chairmanReturnDate?.toIso8601String(),
    ...
    return _exportRecords(
      ...
      headers: const [
        ...
        'Letter Number',
        'Letter Date',
        'Chairman Incoming Number',
        'Chairman Incoming Date',
        'Chairman Return Number',
        'Chairman Return Date',
        'Attachments',
        'Subject',
        'Notes',
        'Needs Followup',
  ...
  Future<String> exportSadir({
    ...
    final rows = records
        .map((sadir) => <String>[
              ...
              _formatNullableDate(sadir.chairmanIncomingDate),
              sadir.chairmanReturnNumber ?? '',
              _formatNullableDate(sadir.chairmanReturnDate),
    ...
    final jsonRows = records.map((sadir) {
      return <String, dynamic>{
        ...
        'chairman_incoming_number': sadir.chairmanIncomingNumber,
        'chairman_incoming_date': sadir.chairmanIncomingDate?.toIso8601String(),
        'chairman_return_number': sadir.chairmanReturnNumber,
        'chairman_return_date': sadir.chairmanReturnDate?.toIso8601String(),
