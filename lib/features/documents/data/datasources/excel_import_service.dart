    ...
    for (var i = 1; i < sheetRows.length; i++) {
      ...
      try {
        ...
        final warid = WaridModel(
          ...
          chairmanIncomingNumber: _nullableText(
              _readText(row, columnMap['chairman_incoming_number'])),
          chairmanIncomingDate:
              _readDate(row, columnMap['chairman_incoming_date']),
          chairmanReturnNumber: _nullableText(
              _readText(row, columnMap['chairman_return_number'])),
          chairmanReturnDate: _readDate(row, columnMap['chairman_return_date']),
