...
class _WaridFormScreenState extends State<WaridFormScreen> {
  ...
  void initState() {
    ...
    } else if (widget.prefillWarid != null) {
      _loadWaridData(widget.prefillWarid!);
    }
  ...
  void _loadWaridData(WaridModel w) {
    ...
    _chairmanIncomingNumberController.text = w.chairmanIncomingNumber ?? '';
    _chairmanIncomingDate = w.chairmanIncomingDate;
    _chairmanReturnNumberController.text = w.chairmanReturnNumber ?? '';
    _chairmanReturnDate = w.chairmanReturnDate;
  ...
  Future<void> _loadClassificationOptions() async {
    ...
    setState(() {
      ...
      _addOptionIfMissing(_classificationOptions, _sourceAdminController.text);
      _addOptionIfMissing(_classificationOptions, _recipient1Controller.text);
      _addOptionIfMissing(_classificationOptions, _recipient2Controller.text);
      _addOptionIfMissing(_classificationOptions, _recipient3Controller.text);
  ...
  Future<void> _save() async {
    ...
    final sourceAdministration = _sourceAdminController.text.trim();
    final recipient1 = _recipient1Controller.text.trim();
    final recipient2 = _recipient2Controller.text.trim();
    final recipient3 = _recipient3Controller.text.trim();
    final warid = WaridModel(
      ...
      recipient1Name: recipient1.isEmpty ? null : recipient1,
      recipient1DeliveryDate: _recipient1Date,
      recipient2Name: recipient2.isEmpty ? null : recipient2,
      recipient2DeliveryDate: _recipient2Date,
      recipient3Name: recipient3.isEmpty ? null : recipient3,
      ...
      updatedAt: isEditing
          ? widget.editWarid!.updatedAt
          : (isRestoring ? widget.initialWarid?.updatedAt : null),
                  ...
                  children: [
                    ...
                    if (_isLoadingClassifications)
                      ...
                      _buildEntityDropdownField(
                        ...
                        value: _sourceAdminController.text.trim().isEmpty
                            ? null
                            : _sourceAdminController.text.trim(),
                        required: true,
                        allowEmpty: false,
                        onChanged: (value) {
                          setState(() {
                            _sourceAdminController.text = value ?? '';
                          });
                        },
                      ),
                      ...
                      _buildResponsiveRow(
                        first: _buildEntityDropdownField(
                          label:
                              '\u0627\u0644\u062c\u0647\u0629 \u0627\u0644\u0645\u0633\u062a\u0644\u0645\u0629 ${i + 1}',
                          value: [
                            _recipient1Controller.text,
                            _recipient2Controller.text,
                            _recipient3Controller.text,
                          ][i]
                                  .trim()
                                  .isEmpty
                              ? null
                          ...
                          onChanged: (value) {
                            setState(() {
                              ...
                              if (i == 0) {
                                _recipient1Controller.text = normalized;
                              } else if (i == 1) {
                                _recipient2Controller.text = normalized;
                              } else {
                                _recipient3Controller.text = normalized;
                              }
                            });
                          },
                        ),
